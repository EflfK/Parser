<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormulaParserTest.aspx.cs" Inherits="Kamradt.Parser.Web.Test.FormulaParserTest" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <fp:StandardFormattedFormula runat="server" ID="TestFormattedFormula" Formula="(ifnull(x,6)+y)/z">
                <VariableTemplate>
                    <a href="http://www.google.com?test=<%# Stuff(Eval("VariableName").ToString()) %>"><%#Eval("VariableName") %></a>
                </VariableTemplate>
                <AndTemplate>
                ...
                <StaticValueTemplate>
                    <label style="color:green;"><%#Eval("Value") %></label>
                </StaticValueTemplate>
            </fp:StandardFormattedFormula>
        </div>
    </form>
</body>
</html>